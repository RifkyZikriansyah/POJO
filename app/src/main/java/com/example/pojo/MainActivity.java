    ...
    public void onClick(View v){
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                        ...
                        moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Rifky Zikriansyah Budiman");
                        moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 16);
                        startActivity(moveWithDataIntent);
                        break;
            case R.id.btn_move_activity_object:
                        person mperson = new person();
                        mperson.setName("Rifky Zikriansyah Budiman");
                        mperson.setAge(16);
                        mperson.setEmail("zikriansyah2002@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "081224889238";
